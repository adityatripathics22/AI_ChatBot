...
const API_KEY = "AIzaSyDIS7jmaMfS7lDED1BiwS8Iy9AUwsg8MEw";
const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent = ${API_KEY}`;
